<template>
    <div class="selecttime">
        ...
        <li class="serveraddr bdr-bottom" v-show="!addOn">
            <div class="mask" v-show="!addOn" @click="chooseAddr"></div>
            <i class="bg-pic"></i>
            <span>服务地址</span>
            <i v-show="!addOn">选择服务地址</i>
            <img v-show="!addOn" src="//gfs13.gomein.net.cn/T1lSYjBXCT1RCvBVdK.png" />
        </li>
        <div class="addr" v-show="addOn">
            <div class="bottom bdr-bottom" @click="chooseAddr">
                <i class="bg-pic"></i>
                <span class="name">
        ...
        <li @click="servertime" class="servertime bdr-bottom">
            <i class="bg-pic time-pic"></i>
            <span>上门时间</span>
            <i>{{serverTime.day==null?'选择上门时间':serverTime.day+' '+serverTime.week}}</i>
            <img src="//gfs13.gomein.net.cn/T1lSYjBXCT1RCvBVdK.png" />
        </li>
...
.selecttime li .bg-pic,
.selecttime .addr .bg-pic {
    position: absolute;
    width:.4rem;
    height: 1.6rem;
    background: url("//gfs12.gomein.net.cn/T1DyhjB4h_1RCvBVdK.png") no-repeat 0;
    background-size: .4rem .4266667rem;
    left:0;
}
.selecttime .addr .bg-pic {
    height: 2rem;
}
.selecttime li .time-pic {
    background: url("//gfs10.gomein.net.cn/T19UDgBbCT1RCvBVdK.png") no-repeat 0;
    background-size: .4rem .4266667rem;
}
.addr {
    width: 100%;
