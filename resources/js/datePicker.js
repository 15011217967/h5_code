        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '<div class="date_btn lcalendar_cancel" style="color:#ccc;">取消</div>' +
                    '<div class="date_btn lcalendar_cancel">请选择购买时间</div>' +
                    '<div class="date_btn lcalendar_finish" style="color:#ff4b46;">确定</div>' +
                    '</div>' +
            ...
            function finishMobileDate(e) {
                ...
                _self.trigger.value = _self.value = (date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd;
